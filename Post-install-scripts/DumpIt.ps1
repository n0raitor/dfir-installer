...
if (Test-Path -Path "C:\DFIR\DumpIt") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Volatile\DumpIt.lnk" -ItemType SymbolicLink -Target "C:\DFIR\DumpIt" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\DumpIt"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Volatile\DumpIt.lnk" -ItemType SymbolicLink -Target "C:\DFIR\DumpIt\DumpIt.exe" -Force
