...
if (Test-Path -Path "C:\DFIR\SpyStudio") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Malware Analysis\SpyStudio.lnk" -ItemType SymbolicLink -Target "C:\DFIR\SpyStudio" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\SpyStudio"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Malware Analysis\SpyStudio.lnk" -ItemType SymbolicLink -Target "C:\DFIR\SpyStudio\SpyStudio.exe" -Force
