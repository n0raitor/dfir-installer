...
if (Test-Path -Path "C:\DFIR\JoakimSchichtTools") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Collections\JoakimSchichtTools.lnk" -ItemType SymbolicLink -Target "C:\DFIR\JoakimSchichtTools" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\JoakimSchichtTools"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Collections\JoakimSchichtTools.lnk" -ItemType SymbolicLink -Target "C:\DFIR\JoakimSchichtTools\JoakimSchichtTools.exe" -Force
