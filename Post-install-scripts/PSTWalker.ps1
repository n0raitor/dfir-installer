...
if (Test-Path -Path "C:\DFIR\PSTWalker") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Email Tools\PSTWalker.lnk" -ItemType SymbolicLink -Target "C:\DFIR\PSTWalker" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\PSTWalker"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Email Tools\PSTWalker.lnk" -ItemType SymbolicLink -Target "C:\DFIR\PSTWalker\PSTWalker.exe" -Force
