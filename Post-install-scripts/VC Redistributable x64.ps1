...
if (Test-Path -Path "C:\DFIR\VC Redistributable x64") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Frameworks\VC Redistributable x64.lnk" -ItemType SymbolicLink -Target "C:\DFIR\VC Redistributable x64" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\VC Redistributable x64"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Frameworks\VC Redistributable x64.lnk" -ItemType SymbolicLink -Target "C:\DFIR\VC Redistributable x64\VC Redistributable x64.exe" -Force
