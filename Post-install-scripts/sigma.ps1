...
if (Test-Path -Path "C:\DFIR\sigma") {
    ...
    New-Item -Path "C:\DFIR\_Tools\IOC Scanner\sigma.lnk" -ItemType SymbolicLink -Target "C:\DFIR\sigma" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\sigma"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\IOC Scanner\sigma.lnk" -ItemType SymbolicLink -Target "C:\DFIR\sigma\sigma.exe" -Force
