...
if (Test-Path -Path "C:\DFIR\LordPE") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Malware Analysis\LordPE.lnk" -ItemType SymbolicLink -Target "C:\DFIR\LordPE" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\LordPE"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Malware Analysis\LordPE.lnk" -ItemType SymbolicLink -Target "C:\DFIR\LordPE\LordPE.exe" -Force
