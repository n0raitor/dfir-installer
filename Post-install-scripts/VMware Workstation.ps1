...
if (Test-Path -Path "C:\DFIR\VMware Workstation") {
    ...
    New-Item -Path "C:\DFIR\_Tools\VM\VMware Workstation.lnk" -ItemType SymbolicLink -Target "C:\DFIR\VMware Workstation" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\VMware Workstation"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\VM\VMware Workstation.lnk" -ItemType SymbolicLink -Target "C:\DFIR\VMware Workstation\VMware Workstation.exe" -Force
