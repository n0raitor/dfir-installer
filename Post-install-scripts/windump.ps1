...
if (Test-Path -Path "C:\DFIR\windump") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Volatile\windump.lnk" -ItemType SymbolicLink -Target "C:\DFIR\windump" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\windump"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Volatile\windump.lnk" -ItemType SymbolicLink -Target "C:\DFIR\windump\windump.exe" -Force
