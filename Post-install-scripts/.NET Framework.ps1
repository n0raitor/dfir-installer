...
if (Test-Path -Path "C:\DFIR\.NET Framework") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Frameworks\.NET Framework.lnk" -ItemType SymbolicLink -Target "C:\DFIR\.NET Framework" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\.NET Framework"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Frameworks\.NET Framework.lnk" -ItemType SymbolicLink -Target "C:\DFIR\.NET Framework\.NET Framework.exe" -Force
