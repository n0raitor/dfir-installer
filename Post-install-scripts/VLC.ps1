...
if (Test-Path -Path "C:\DFIR\VLC") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Media\VLC.lnk" -ItemType SymbolicLink -Target "C:\DFIR\VLC" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\VLC"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Media\VLC.lnk" -ItemType SymbolicLink -Target "C:\DFIR\VLC\VLC.exe" -Force
