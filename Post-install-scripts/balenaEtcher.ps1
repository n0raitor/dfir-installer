...
if (Test-Path -Path "C:\DFIR\balenaEtcher") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Media\balenaEtcher" -ItemType SymbolicLink -Target "C:\DFIR\balenaEtcher" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\balenaEtcher"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Media\balenaEtcher" -ItemType SymbolicLink -Target "C:\DFIR\balenaEtcher\balenaEtcher.exe" -Force
