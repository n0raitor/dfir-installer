...
if (Test-Path -Path "C:\DFIR\iTopEasyDesktop") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Recommended\iTopEasyDesktop.lnk" -ItemType SymbolicLink -Target "C:\DFIR\iTopEasyDesktop" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\iTopEasyDesktop"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Recommended\iTopEasyDesktop.lnk" -ItemType SymbolicLink -Target "C:\DFIR\iTopEasyDesktop\iTopEasyDesktop.exe" -Force
