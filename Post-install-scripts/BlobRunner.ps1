...
if (Test-Path -Path "C:\DFIR\BlobRunner") {
    ...
    New-Item -Path "C:\DFIR\_Tools\SRE\BlobRunner.lnk" -ItemType SymbolicLink -Target "C:\DFIR\BlobRunner" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\BlobRunner"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\SRE\BlobRunner.lnk" -ItemType SymbolicLink -Target "C:\DFIR\BlobRunner\BlobRunner.exe" -Force
