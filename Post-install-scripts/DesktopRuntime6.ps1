...
if (Test-Path -Path "C:\DFIR\DesktopRuntime6") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Frameworks\DesktopRuntime6.lnk" -ItemType SymbolicLink -Target "C:\DFIR\DesktopRuntime6" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\DesktopRuntime6"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Frameworks\DesktopRuntime6.lnk" -ItemType SymbolicLink -Target "C:\DFIR\DesktopRuntime6\DesktopRuntime6.exe" -Force
