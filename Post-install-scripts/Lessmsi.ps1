...
if (Test-Path -Path "C:\DFIR\Lessmsi") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Malware Analysis\Lessmsi.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Lessmsi" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Lessmsi"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Malware Analysis\Lessmsi.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Lessmsi\Lessmsi.exe" -Force
