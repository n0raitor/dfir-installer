...
if (Test-Path -Path "C:\DFIR\Firefox") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Browser Tools\Firefox.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Firefox" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Firefox"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Browser Tools\Firefox.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Firefox\Firefox.exe" -Force
