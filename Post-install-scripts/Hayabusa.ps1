...
if (Test-Path -Path "C:\DFIR\Hayabusa") {
    ...
    New-Item -Path "C:\DFIR\_Tools\IOC Scanner\Hayabusa.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Hayabusa" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Hayabusa"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\IOC Scanner\Hayabusa.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Hayabusa\Hayabusa.exe" -Force
