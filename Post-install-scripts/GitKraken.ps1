...
if (Test-Path -Path "C:\DFIR\GitKraken") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Dev\GitKraken.lnk" -ItemType SymbolicLink -Target "C:\DFIR\GitKraken" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\GitKraken"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Dev\GitKraken.lnk" -ItemType SymbolicLink -Target "C:\DFIR\GitKraken\GitKraken.exe" -Force
