...
if (Test-Path -Path "C:\DFIR\GeForceExperience") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Driver\GeForceExperience.lnk" -ItemType SymbolicLink -Target "C:\DFIR\GeForceExperience" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\GeForceExperience"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Driver\GeForceExperience.lnk" -ItemType SymbolicLink -Target "C:\DFIR\GeForceExperience\GeForceExperience.exe" -Force
