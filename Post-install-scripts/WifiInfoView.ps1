...
if (Test-Path -Path "C:\DFIR\WifiInfoView") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Network\WifiInfoView.lnk" -ItemType SymbolicLink -Target "C:\DFIR\WifiInfoView" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\WifiInfoView"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Network\WifiInfoView.lnk" -ItemType SymbolicLink -Target "C:\DFIR\WifiInfoView\WifiInfoView.exe" -Force
