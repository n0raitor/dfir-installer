...
if (Test-Path -Path "C:\DFIR\OneNoteAnalyzer") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Malware Analysis\OneNoteAnalyzer.lnk" -ItemType SymbolicLink -Target "C:\DFIR\OneNoteAnalyzer" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\OneNoteAnalyzer"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Malware Analysis\OneNoteAnalyzer.lnk" -ItemType SymbolicLink -Target "C:\DFIR\OneNoteAnalyzer\OneNoteAnalyzer.exe" -Force
