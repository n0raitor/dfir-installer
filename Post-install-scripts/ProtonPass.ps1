...
if (Test-Path -Path "C:\DFIR\ProtonPass") {
    ...
    New-Item -Path "C:\DFIR\_Tools\System Utilities\ProtonPass.lnk" -ItemType SymbolicLink -Target "C:\DFIR\ProtonPass" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\ProtonPass"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\System Utilities\ProtonPass.lnk" -ItemType SymbolicLink -Target "C:\DFIR\ProtonPass\ProtonPass.exe" -Force
