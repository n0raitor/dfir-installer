...
if (Test-Path -Path "C:\DFIR\Eraser") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Carving\Eraser.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Eraser" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Eraser"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Carving\Eraser.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Eraser\Eraser.exe" -Force
