...
if (Test-Path -Path "C:\DFIR\IFPSTools") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Other\IFPSTools.lnk" -ItemType SymbolicLink -Target "C:\DFIR\IFPSTools" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\IFPSTools"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Other\IFPSTools.lnk" -ItemType SymbolicLink -Target "C:\DFIR\IFPSTools\IFPSTools.exe" -Force
