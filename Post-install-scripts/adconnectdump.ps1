...
if (Test-Path -Path "C:\DFIR\adconnectdump") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Offensive\adconnectdump.lnk" -ItemType SymbolicLink -Target "C:\DFIR\adconnectdump" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\adconnectdump"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Offensive\adconnectdump.lnk" -ItemType SymbolicLink -Target "C:\DFIR\adconnectdump\adconnectdump.exe" -Force
