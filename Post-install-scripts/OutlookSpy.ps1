...
if (Test-Path -Path "C:\DFIR\OutlookSpy") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Email Tools\OutlookSpy.lnk" -ItemType SymbolicLink -Target "C:\DFIR\OutlookSpy" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\OutlookSpy"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Email Tools\OutlookSpy.lnk" -ItemType SymbolicLink -Target "C:\DFIR\OutlookSpy\OutlookSpy.exe" -Force
