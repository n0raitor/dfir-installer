...
if (Test-Path -Path "C:\DFIR\Wireshark") {
    # Create symlink if tool directory exists
    New-Item -Path "C:\DFIR\_Tools\Network\Wireshark.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Wireshark" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Wireshark"
}
