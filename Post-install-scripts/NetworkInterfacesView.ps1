...
if (Test-Path -Path "C:\DFIR\NetworkInterfacesView") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Network\NetworkInterfacesView.lnk" -ItemType SymbolicLink -Target "C:\DFIR\NetworkInterfacesView" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\NetworkInterfacesView"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Network\NetworkInterfacesView.lnk" -ItemType SymbolicLink -Target "C:\DFIR\NetworkInterfacesView\NetworkInterfacesView.exe" -Force
