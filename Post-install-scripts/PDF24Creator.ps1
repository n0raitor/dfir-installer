...
if (Test-Path -Path "C:\DFIR\PDF24Creator") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Office\PDF24Creator.lnk" -ItemType SymbolicLink -Target "C:\DFIR\PDF24Creator" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\PDF24Creator"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Office\PDF24Creator.lnk" -ItemType SymbolicLink -Target "C:\DFIR\PDF24Creator\PDF24Creator.exe" -Force
