...
if (Test-Path -Path "C:\DFIR\NirSoft NK2Edit") {
    ...
    New-Item -Path "C:\DFIR\_Tools\DEP\NirSoft NK2Edit.lnk" -ItemType SymbolicLink -Target "C:\DFIR\NirSoft NK2Edit" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\NirSoft NK2Edit"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\DEP\NirSoft NK2Edit.lnk" -ItemType SymbolicLink -Target "C:\DFIR\NirSoft NK2Edit\NirSoft NK2Edit.exe" -Force
