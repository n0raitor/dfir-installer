...
if (Test-Path -Path "C:\DFIR\MemoryDumperx86") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Volatile\MemoryDumperx86.lnk" -ItemType SymbolicLink -Target "C:\DFIR\MemoryDumperx86" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\MemoryDumperx86"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Volatile\MemoryDumperx86.lnk" -ItemType SymbolicLink -Target "C:\DFIR\MemoryDumperx86\MemoryDumperx86.exe" -Force
