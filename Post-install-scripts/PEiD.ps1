...
if (Test-Path -Path "C:\DFIR\PEiD") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Malware Analysis\PEiD.lnk" -ItemType SymbolicLink -Target "C:\DFIR\PEiD" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\PEiD"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Malware Analysis\PEiD.lnk" -ItemType SymbolicLink -Target "C:\DFIR\PEiD\PEiD.exe" -Force
