...
if (Test-Path -Path "C:\DFIR\densityscout") {
    ...
    New-Item -Path "C:\DFIR\_Tools\IOC Scanner\densityscout.lnk" -ItemType SymbolicLink -Target "C:\DFIR\densityscout" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\densityscout"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\IOC Scanner\densityscout.lnk" -ItemType SymbolicLink -Target "C:\DFIR\densityscout\densityscout.exe" -Force
