...
if (Test-Path -Path "C:\DFIR\WindowsSDK10") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Frameworks\WindowsSDK10.lnk" -ItemType SymbolicLink -Target "C:\DFIR\WindowsSDK10" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\WindowsSDK10"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Frameworks\WindowsSDK10.lnk" -ItemType SymbolicLink -Target "C:\DFIR\WindowsSDK10\WindowsSDK10.exe" -Force
