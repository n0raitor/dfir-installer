...
if (Test-Path -Path "C:\DFIR\Floss") {
    # Create symlink if tool directory exists
    New-Item -Path "C:\DFIR\_Tools\Malware Analysis\Floss.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Floss" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Floss"
}
