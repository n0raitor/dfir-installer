...
if (Test-Path -Path "C:\DFIR\MagnetRAMCapture") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Acquisition Tools\MagnetRAMCapture.lnk" -ItemType SymbolicLink -Target "C:\DFIR\MagnetRAMCapture" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\MagnetRAMCapture"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Acquisition Tools\MagnetRAMCapture.lnk" -ItemType SymbolicLink -Target "C:\DFIR\MagnetRAMCapture\MagnetRAMCapture.exe" -Force
