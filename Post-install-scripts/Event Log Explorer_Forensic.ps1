...
if (Test-Path -Path "C:\DFIR\Event Log Explorer_Forensic") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Event Log Tools\Event Log Explorer_Forensic.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Event Log Explorer_Forensic" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Event Log Explorer_Forensic"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Event Log Tools\Event Log Explorer_Forensic.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Event Log Explorer_Forensic\Event Log Explorer_Forensic.exe" -Force
