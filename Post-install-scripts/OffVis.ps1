...
if (Test-Path -Path "C:\DFIR\OffVis") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Malware Analysis\OffVis.lnk" -ItemType SymbolicLink -Target "C:\DFIR\OffVis" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\OffVis"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Malware Analysis\OffVis.lnk" -ItemType SymbolicLink -Target "C:\DFIR\OffVis\OffVis.exe" -Force
