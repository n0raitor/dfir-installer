...
if (Test-Path -Path "C:\DFIR\bring2lite") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Browser Tools\bring2lite.lnk" -ItemType SymbolicLink -Target "C:\DFIR\bring2lite" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\bring2lite"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Browser Tools\bring2lite.lnk" -ItemType SymbolicLink -Target "C:\DFIR\bring2lite\bring2lite.exe" -Force
