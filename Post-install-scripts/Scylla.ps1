...
if (Test-Path -Path "C:\DFIR\Scylla") {
    ...
    New-Item -Path "C:\DFIR\_Tools\OSINT\Scylla.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Scylla" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Scylla"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\OSINT\Scylla.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Scylla\Scylla.exe" -Force
