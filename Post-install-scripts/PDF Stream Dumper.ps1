...
if (Test-Path -Path "C:\DFIR\PDF Stream Dumper") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Malware Analysis\PDF Stream Dumper.lnk" -ItemType SymbolicLink -Target "C:\DFIR\PDF Stream Dumper" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\PDF Stream Dumper"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Malware Analysis\PDF Stream Dumper.lnk" -ItemType SymbolicLink -Target "C:\DFIR\PDF Stream Dumper\PDF Stream Dumper.exe" -Force
