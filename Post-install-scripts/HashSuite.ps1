...
if (Test-Path -Path "C:\DFIR\HashSuite") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Offensive\HashSuite.lnk" -ItemType SymbolicLink -Target "C:\DFIR\HashSuite" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\HashSuite"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Offensive\HashSuite.lnk" -ItemType SymbolicLink -Target "C:\DFIR\HashSuite\HashSuite.exe" -Force
