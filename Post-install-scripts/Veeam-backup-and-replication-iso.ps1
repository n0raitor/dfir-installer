...
if (Test-Path -Path "C:\DFIR\Veeam-backup-and-replication-iso") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Backup\Veeam-backup-and-replication-iso.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Veeam-backup-and-replication-iso" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Veeam-backup-and-replication-iso"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Backup\Veeam-backup-and-replication-iso.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Veeam-backup-and-replication-iso\Veeam-backup-and-replication-iso.exe" -Force
