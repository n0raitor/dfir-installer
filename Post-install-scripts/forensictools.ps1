...
if (Test-Path -Path "C:\DFIR\forensictools") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Collections\forensictools.lnk" -ItemType SymbolicLink -Target "C:\DFIR\forensictools" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\forensictools"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Collections\forensictools.lnk" -ItemType SymbolicLink -Target "C:\DFIR\forensictools\forensictools.exe" -Force
