...
if (Test-Path -Path "C:\DFIR\BuildTools") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Recommended\BuildTools.lnk" -ItemType SymbolicLink -Target "C:\DFIR\BuildTools" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\BuildTools"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Recommended\BuildTools.lnk" -ItemType SymbolicLink -Target "C:\DFIR\BuildTools\BuildTools.exe" -Force
