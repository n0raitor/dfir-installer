...
if (Test-Path -Path "C:\DFIR\Innounp") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Other\Innounp.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Innounp" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Innounp"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Other\Innounp.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Innounp\Innounp.exe" -Force
