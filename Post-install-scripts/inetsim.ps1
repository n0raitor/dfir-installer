...
if (Test-Path -Path "C:\DFIR\inetsim") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Other\inetsim.lnk" -ItemType SymbolicLink -Target "C:\DFIR\inetsim" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\inetsim"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Other\inetsim.lnk" -ItemType SymbolicLink -Target "C:\DFIR\inetsim\inetsim.exe" -Force
