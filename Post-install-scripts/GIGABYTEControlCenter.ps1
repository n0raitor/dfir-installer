...
if (Test-Path -Path "C:\DFIR\GIGABYTEControlCenter") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Driver\GIGABYTEControlCenter.lnk" -ItemType SymbolicLink -Target "C:\DFIR\GIGABYTEControlCenter" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\GIGABYTEControlCenter"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Driver\GIGABYTEControlCenter.lnk" -ItemType SymbolicLink -Target "C:\DFIR\GIGABYTEControlCenter\GIGABYTEControlCenter.exe" -Force
