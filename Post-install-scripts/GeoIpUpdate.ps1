...
if (Test-Path -Path "C:\DFIR\GeoIpUpdate") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Network\GeoIpUpdate.lnk" -ItemType SymbolicLink -Target "C:\DFIR\GeoIpUpdate" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\GeoIpUpdate"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Network\GeoIpUpdate.lnk" -ItemType SymbolicLink -Target "C:\DFIR\GeoIpUpdate\GeoIpUpdate.exe" -Force
