...
if (Test-Path -Path "C:\DFIR\Runtime6") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Frameworks\Runtime6.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Runtime6" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Runtime6"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Frameworks\Runtime6.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Runtime6\Runtime6.exe" -Force
