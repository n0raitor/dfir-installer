...
if (Test-Path -Path "C:\DFIR\ChromeCacheView") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Browser Tools\ChromeCacheView.lnk" -ItemType SymbolicLink -Target "C:\DFIR\ChromeCacheView" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\ChromeCacheView"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Browser Tools\ChromeCacheView.lnk" -ItemType SymbolicLink -Target "C:\DFIR\ChromeCacheView\ChromeCacheView.exe" -Force
