...
if (Test-Path -Path "C:\DFIR\OleTools") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Collections\OleTools.lnk" -ItemType SymbolicLink -Target "C:\DFIR\OleTools" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\OleTools"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Collections\OleTools.lnk" -ItemType SymbolicLink -Target "C:\DFIR\OleTools\OleTools.exe" -Force
