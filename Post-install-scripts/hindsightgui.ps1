...
if (Test-Path -Path "C:\DFIR\hindsightgui") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Browser Tools\hindsightgui.lnk" -ItemType SymbolicLink -Target "C:\DFIR\hindsightgui" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\hindsightgui"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Browser Tools\hindsightgui.lnk" -ItemType SymbolicLink -Target "C:\DFIR\hindsightgui\hindsightgui.exe" -Force
