...
if (Test-Path -Path "C:\DFIR\OBSStudio") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Media\OBSStudio.lnk" -ItemType SymbolicLink -Target "C:\DFIR\OBSStudio" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\OBSStudio"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Media\OBSStudio.lnk" -ItemType SymbolicLink -Target "C:\DFIR\OBSStudio\OBSStudio.exe" -Force
