...
if (Test-Path -Path "C:\DFIR\EncryptedDiskHunter") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Acquisition Tools\EncryptedDiskHunter.lnk" -ItemType SymbolicLink -Target "C:\DFIR\EncryptedDiskHunter" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\EncryptedDiskHunter"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Acquisition Tools\EncryptedDiskHunter.lnk" -ItemType SymbolicLink -Target "C:\DFIR\EncryptedDiskHunter\EncryptedDiskHunter.exe" -Force
