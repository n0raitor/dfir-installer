...
if (Test-Path -Path "C:\DFIR\SynologyActiveBackupforBusinessAgent") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Backup\SynologyActiveBackupforBusinessAgent.lnk" -ItemType SymbolicLink -Target "C:\DFIR\SynologyActiveBackupforBusinessAgent" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\SynologyActiveBackupforBusinessAgent"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Backup\SynologyActiveBackupforBusinessAgent.lnk" -ItemType SymbolicLink -Target "C:\DFIR\SynologyActiveBackupforBusinessAgent\SynologyActiveBackupforBusinessAgent.exe" -Force
