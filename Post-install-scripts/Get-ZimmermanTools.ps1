...
if (Test-Path -Path "C:\DFIR\Get-ZimmermanTools") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Collections\Get-ZimmermanTools.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Get-ZimmermanTools" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Get-ZimmermanTools"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Collections\Get-ZimmermanTools.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Get-ZimmermanTools\Get-ZimmermanTools.exe" -Force
