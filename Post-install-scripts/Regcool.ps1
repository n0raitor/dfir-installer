...
if (Test-Path -Path "C:\DFIR\Regcool") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Registry Tools\Regcool.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Regcool" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Regcool"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Registry Tools\Regcool.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Regcool\Regcool.exe" -Force
