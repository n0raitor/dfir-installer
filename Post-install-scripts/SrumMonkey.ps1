...
if (Test-Path -Path "C:\DFIR\SrumMonkey") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Other\SrumMonkey.lnk" -ItemType SymbolicLink -Target "C:\DFIR\SrumMonkey" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\SrumMonkey"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Other\SrumMonkey.lnk" -ItemType SymbolicLink -Target "C:\DFIR\SrumMonkey\SrumMonkey.exe" -Force
