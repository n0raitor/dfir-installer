...
if (Test-Path -Path "C:\DFIR\openstego") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Stegano\openstego.lnk" -ItemType SymbolicLink -Target "C:\DFIR\openstego" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\openstego"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Stegano\openstego.lnk" -ItemType SymbolicLink -Target "C:\DFIR\openstego\openstego.exe" -Force
