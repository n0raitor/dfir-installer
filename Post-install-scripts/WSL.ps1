...
if (Test-Path -Path "C:\DFIR\WSL") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Linux\WSL.lnk" -ItemType SymbolicLink -Target "C:\DFIR\WSL" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\WSL"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Linux\WSL.lnk" -ItemType SymbolicLink -Target "C:\DFIR\WSL\WSL.exe" -Force
