...
if (Test-Path -Path "C:\DFIR\Partition-4DiagnosticParser") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Event Log Tools\Partition-4DiagnosticParser.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Partition-4DiagnosticParser" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Partition-4DiagnosticParser"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Event Log Tools\Partition-4DiagnosticParser.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Partition-4DiagnosticParser\Partition-4DiagnosticParser.exe" -Force
