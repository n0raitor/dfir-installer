...
if (Test-Path -Path "C:\DFIR\Event Log Explorer Old") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Event Log Tools\Event Log Explorer Old.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Event Log Explorer Old" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Event Log Explorer Old"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Event Log Tools\Event Log Explorer Old.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Event Log Explorer Old\Event Log Explorer Old.exe" -Force
