...
if (Test-Path -Path "C:\DFIR\BloodHound") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Offensive\BloodHound.lnk" -ItemType SymbolicLink -Target "C:\DFIR\BloodHound" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\BloodHound"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Offensive\BloodHound.lnk" -ItemType SymbolicLink -Target "C:\DFIR\BloodHound\BloodHound.exe" -Force
