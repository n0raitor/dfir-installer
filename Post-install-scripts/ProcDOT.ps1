...
if (Test-Path -Path "C:\DFIR\ProcDOT") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Debugger\ProcDOT.lnk" -ItemType SymbolicLink -Target "C:\DFIR\ProcDOT" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\ProcDOT"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Debugger\ProcDOT.lnk" -ItemType SymbolicLink -Target "C:\DFIR\ProcDOT\ProcDOT.exe" -Force
