...
if (Test-Path -Path "C:\DFIR\DriveFS-Sleuth") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Browser Tools\DriveFS-Sleuth.lnk" -ItemType SymbolicLink -Target "C:\DFIR\DriveFS-Sleuth" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\DriveFS-Sleuth"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Browser Tools\DriveFS-Sleuth.lnk" -ItemType SymbolicLink -Target "C:\DFIR\DriveFS-Sleuth\DriveFS-Sleuth.exe" -Force
