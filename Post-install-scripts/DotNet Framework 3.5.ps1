...
if (Test-Path -Path "C:\DFIR\DotNet Framework 3.5") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Frameworks\DotNet Framework 3.5.lnk" -ItemType SymbolicLink -Target "C:\DFIR\DotNet Framework 3.5" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\DotNet Framework 3.5"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Frameworks\DotNet Framework 3.5.lnk" -ItemType SymbolicLink -Target "C:\DFIR\DotNet Framework 3.5\DotNet Framework 3.5.exe" -Force
