...
if (Test-Path -Path "C:\DFIR\VisualStudioEnterprise2022") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Dev\VisualStudioEnterprise2022.lnk" -ItemType SymbolicLink -Target "C:\DFIR\VisualStudioEnterprise2022" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\VisualStudioEnterprise2022"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Dev\VisualStudioEnterprise2022.lnk" -ItemType SymbolicLink -Target "C:\DFIR\VisualStudioEnterprise2022\VisualStudioEnterprise2022.exe" -Force
