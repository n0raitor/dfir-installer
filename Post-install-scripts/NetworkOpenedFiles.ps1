...
if (Test-Path -Path "C:\DFIR\NetworkOpenedFiles") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Network\NetworkOpenedFiles.lnk" -ItemType SymbolicLink -Target "C:\DFIR\NetworkOpenedFiles" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\NetworkOpenedFiles"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Network\NetworkOpenedFiles.lnk" -ItemType SymbolicLink -Target "C:\DFIR\NetworkOpenedFiles\NetworkOpenedFiles.exe" -Force
