...
if (Test-Path -Path "C:\DFIR\KaliLinux") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Offensive\KaliLinux.lnk" -ItemType SymbolicLink -Target "C:\DFIR\KaliLinux" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\KaliLinux"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Offensive\KaliLinux.lnk" -ItemType SymbolicLink -Target "C:\DFIR\KaliLinux\KaliLinux.exe" -Force
