...
if (Test-Path -Path "C:\DFIR\Chromagnon") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Browser Tools\Chromagnon.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Chromagnon" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Chromagnon"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Browser Tools\Chromagnon.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Chromagnon\Chromagnon.exe" -Force
