...
if (Test-Path -Path "C:\DFIR\Exchange-edb-viewer") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Email Tools\Exchange-edb-viewer.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Exchange-edb-viewer" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Exchange-edb-viewer"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Email Tools\Exchange-edb-viewer.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Exchange-edb-viewer\Exchange-edb-viewer.exe" -Force
