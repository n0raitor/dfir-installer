...
if (Test-Path -Path "C:\DFIR\Python3.11") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Dev\Python3.11.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Python3.11" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Python3.11"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Dev\Python3.11.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Python3.11\Python3.11.exe" -Force
