...
if (Test-Path -Path "C:\DFIR\Whisker") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Offensive\Whisker.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Whisker" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Whisker"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Offensive\Whisker.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Whisker\Whisker.exe" -Force
