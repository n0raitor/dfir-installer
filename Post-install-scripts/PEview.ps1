...
if (Test-Path -Path "C:\DFIR\PEview") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Malware Analysis\PEview.lnk" -ItemType SymbolicLink -Target "C:\DFIR\PEview" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\PEview"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Malware Analysis\PEview.lnk" -ItemType SymbolicLink -Target "C:\DFIR\PEview\PEview.exe" -Force
