...
if (Test-Path -Path "C:\DFIR\Noriben") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Malware Analysis\Noriben.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Noriben" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Noriben"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Malware Analysis\Noriben.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Noriben\Noriben.exe" -Force
