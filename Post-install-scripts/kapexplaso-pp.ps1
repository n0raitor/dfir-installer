...
if (Test-Path -Path "C:\DFIR\kapexplaso-pp") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Custom\kapexplaso-pp.lnk" -ItemType SymbolicLink -Target "C:\DFIR\kapexplaso-pp" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\kapexplaso-pp"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Custom\kapexplaso-pp.lnk" -ItemType SymbolicLink -Target "C:\DFIR\kapexplaso-pp\kapexplaso-pp.exe" -Force
