...
if (Test-Path -Path "C:\DFIR\ResourcesExtract") {
    ...
    New-Item -Path "C:\DFIR\_Tools\System Utilities\ResourcesExtract.lnk" -ItemType SymbolicLink -Target "C:\DFIR\ResourcesExtract" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\ResourcesExtract"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\System Utilities\ResourcesExtract.lnk" -ItemType SymbolicLink -Target "C:\DFIR\ResourcesExtract\ResourcesExtract.exe" -Force
