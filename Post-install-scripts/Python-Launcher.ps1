...
if (Test-Path -Path "C:\DFIR\Python-Launcher") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Dev\Python-Launcher.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Python-Launcher" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Python-Launcher"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Dev\Python-Launcher.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Python-Launcher\Python-Launcher.exe" -Force
