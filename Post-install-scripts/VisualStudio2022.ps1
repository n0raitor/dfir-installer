...
if (Test-Path -Path "C:\DFIR\VisualStudio2022") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Dev\VisualStudio2022.lnk" -ItemType SymbolicLink -Target "C:\DFIR\VisualStudio2022" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\VisualStudio2022"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Dev\VisualStudio2022.lnk" -ItemType SymbolicLink -Target "C:\DFIR\VisualStudio2022\VisualStudio2022.exe" -Force
