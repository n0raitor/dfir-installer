...
if (Test-Path -Path "C:\DFIR\fqlite") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Other\fqlite.lnk" -ItemType SymbolicLink -Target "C:\DFIR\fqlite" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\fqlite"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Other\fqlite.lnk" -ItemType SymbolicLink -Target "C:\DFIR\fqlite\fqlite.exe" -Force
