...
if (Test-Path -Path "C:\DFIR\VCLibsDesktop14") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Frameworks\VCLibsDesktop14.lnk" -ItemType SymbolicLink -Target "C:\DFIR\VCLibsDesktop14" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\VCLibsDesktop14"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Frameworks\VCLibsDesktop14.lnk" -ItemType SymbolicLink -Target "C:\DFIR\VCLibsDesktop14\VCLibsDesktop14.exe" -Force
