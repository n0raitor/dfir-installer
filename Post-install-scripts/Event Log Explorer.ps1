...
if (Test-Path -Path "C:\DFIR\Event Log Explorer") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Event Log Tools\Event Log Explorer.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Event Log Explorer" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Event Log Explorer"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Event Log Tools\Event Log Explorer.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Event Log Explorer\Event Log Explorer.exe" -Force
