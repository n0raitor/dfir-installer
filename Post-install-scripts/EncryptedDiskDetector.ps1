...
if (Test-Path -Path "C:\DFIR\EncryptedDiskDetector") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Acquisition Tools\EncryptedDiskDetector.lnk" -ItemType SymbolicLink -Target "C:\DFIR\EncryptedDiskDetector" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\EncryptedDiskDetector"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Acquisition Tools\EncryptedDiskDetector.lnk" -ItemType SymbolicLink -Target "C:\DFIR\EncryptedDiskDetector\EncryptedDiskDetector.exe" -Force
