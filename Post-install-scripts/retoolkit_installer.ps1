...
if (Test-Path -Path "C:\DFIR\retoolkit_installer") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Collections\retoolkit_installer.lnk" -ItemType SymbolicLink -Target "C:\DFIR\retoolkit_installer" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\retoolkit_installer"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Collections\retoolkit_installer.lnk" -ItemType SymbolicLink -Target "C:\DFIR\retoolkit_installer\retoolkit_installer.exe" -Force
