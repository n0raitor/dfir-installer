...
if (Test-Path -Path "C:\DFIR\Stracciatella") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Utilities\Stracciatella.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Stracciatella" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Stracciatella"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Utilities\Stracciatella.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Stracciatella\Stracciatella.exe" -Force
