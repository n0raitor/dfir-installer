...
if (Test-Path -Path "C:\DFIR\Vim") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Editors\Vim.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Vim" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Vim"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Editors\Vim.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Vim\Vim.exe" -Force
