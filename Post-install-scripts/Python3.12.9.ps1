...
if (Test-Path -Path "C:\DFIR\Python3.12.9") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Dev\Python3.12.9.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Python3.12.9" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Python3.12.9"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Dev\Python3.12.9.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Python3.12.9\Python3.12.9.exe" -Force
