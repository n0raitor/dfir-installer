...
if (Test-Path -Path "C:\DFIR\qFlipper") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Offensive\qFlipper.lnk" -ItemType SymbolicLink -Target "C:\DFIR\qFlipper" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\qFlipper"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Offensive\qFlipper.lnk" -ItemType SymbolicLink -Target "C:\DFIR\qFlipper\qFlipper.exe" -Force
