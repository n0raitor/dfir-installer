...
if (Test-Path -Path "C:\DFIR\Registryexplorer") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Registry Tools\Registryexplorer.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Registryexplorer" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Registryexplorer"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Registry Tools\Registryexplorer.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Registryexplorer\Registryexplorer.exe" -Force
