...
if (Test-Path -Path "C:\DFIR\WakeMeOnLan") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Other\WakeMeOnLan.lnk" -ItemType SymbolicLink -Target "C:\DFIR\WakeMeOnLan" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\WakeMeOnLan"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Other\WakeMeOnLan.lnk" -ItemType SymbolicLink -Target "C:\DFIR\WakeMeOnLan\WakeMeOnLan.exe" -Force
