...
if (Test-Path -Path "C:\DFIR\WindowsInstallationAssistant") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Driver\WindowsInstallationAssistant.lnk" -ItemType SymbolicLink -Target "C:\DFIR\WindowsInstallationAssistant" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\WindowsInstallationAssistant"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Driver\WindowsInstallationAssistant.lnk" -ItemType SymbolicLink -Target "C:\DFIR\WindowsInstallationAssistant\WindowsInstallationAssistant.exe" -Force
