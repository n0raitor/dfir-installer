...
if (Test-Path -Path "C:\DFIR\vb_decompiler_lite") {
    ...
    New-Item -Path "C:\DFIR\_Tools\SRE\vb_decompiler_lite.lnk" -ItemType SymbolicLink -Target "C:\DFIR\vb_decompiler_lite" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\vb_decompiler_lite"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\SRE\vb_decompiler_lite.lnk" -ItemType SymbolicLink -Target "C:\DFIR\vb_decompiler_lite\vb_decompiler_lite.exe" -Force
