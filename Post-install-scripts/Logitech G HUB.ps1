...
if (Test-Path -Path "C:\DFIR\Logitech G HUB") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Driver\Logitech G HUB.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Logitech G HUB" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Logitech G HUB"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Driver\Logitech G HUB.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Logitech G HUB\Logitech G HUB.exe" -Force
