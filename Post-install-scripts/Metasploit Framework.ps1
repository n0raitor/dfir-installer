...
if (Test-Path -Path "C:\DFIR\Metasploit Framework") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Offensive\Metasploit Framework.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Metasploit Framework" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Metasploit Framework"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Offensive\Metasploit Framework.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Metasploit Framework\Metasploit Framework.exe" -Force
