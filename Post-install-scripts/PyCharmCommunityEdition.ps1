...
if (Test-Path -Path "C:\DFIR\PyCharmCommunityEdition") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Dev\PyCharmCommunityEdition.lnk" -ItemType SymbolicLink -Target "C:\DFIR\PyCharmCommunityEdition" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\PyCharmCommunityEdition"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Dev\PyCharmCommunityEdition.lnk" -ItemType SymbolicLink -Target "C:\DFIR\PyCharmCommunityEdition\PyCharmCommunityEdition.exe" -Force
