...
if (Test-Path -Path "C:\DFIR\SimpleProgramDebugger") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Debugger\SimpleProgramDebugger.lnk" -ItemType SymbolicLink -Target "C:\DFIR\SimpleProgramDebugger" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\SimpleProgramDebugger"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Debugger\SimpleProgramDebugger.lnk" -ItemType SymbolicLink -Target "C:\DFIR\SimpleProgramDebugger\SimpleProgramDebugger.exe" -Force
