...
if (Test-Path -Path "C:\DFIR\kali-windows-binaries") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Offensive\kali-windows-binaries.lnk" -ItemType SymbolicLink -Target "C:\DFIR\kali-windows-binaries" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\kali-windows-binaries"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Offensive\kali-windows-binaries.lnk" -ItemType SymbolicLink -Target "C:\DFIR\kali-windows-binaries\kali-windows-binaries.exe" -Force
