...
if (Test-Path -Path "C:\DFIR\retoolkit2_installer") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Collections\retoolkit2_installer.lnk" -ItemType SymbolicLink -Target "C:\DFIR\retoolkit2_installer" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\retoolkit2_installer"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Collections\retoolkit2_installer.lnk" -ItemType SymbolicLink -Target "C:\DFIR\retoolkit2_installer\retoolkit2_installer.exe" -Force
