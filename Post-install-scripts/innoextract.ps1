...
if (Test-Path -Path "C:\DFIR\innoextract") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Other\innoextract.lnk" -ItemType SymbolicLink -Target "C:\DFIR\innoextract" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\innoextract"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Other\innoextract.lnk" -ItemType SymbolicLink -Target "C:\DFIR\innoextract\innoextract.exe" -Force
