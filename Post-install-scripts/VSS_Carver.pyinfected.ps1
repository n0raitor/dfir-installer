...
if (Test-Path -Path "C:\DFIR\VSS_Carver.pyinfected") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Carving\VSS_Carver.pyinfected.lnk" -ItemType SymbolicLink -Target "C:\DFIR\VSS_Carver.pyinfected" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\VSS_Carver.pyinfected"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Carving\VSS_Carver.pyinfected.lnk" -ItemType SymbolicLink -Target "C:\DFIR\VSS_Carver.pyinfected\VSS_Carver.pyinfected.exe" -Force
