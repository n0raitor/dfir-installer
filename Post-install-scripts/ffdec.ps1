...
if (Test-Path -Path "C:\DFIR\ffdec") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Other\ffdec.lnk" -ItemType SymbolicLink -Target "C:\DFIR\ffdec" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\ffdec"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Other\ffdec.lnk" -ItemType SymbolicLink -Target "C:\DFIR\ffdec\ffdec.exe" -Force
