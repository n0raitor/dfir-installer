...
if (Test-Path -Path "C:\DFIR\Git") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Dev\Git.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Git" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Git"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Dev\Git.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Git\Git.exe" -Force
