...
if (Test-Path -Path "C:\DFIR\VCRedist2015x86") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Frameworks\VCRedist2015x86.lnk" -ItemType SymbolicLink -Target "C:\DFIR\VCRedist2015x86" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\VCRedist2015x86"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Frameworks\VCRedist2015x86.lnk" -ItemType SymbolicLink -Target "C:\DFIR\VCRedist2015x86\VCRedist2015x86.exe" -Force
