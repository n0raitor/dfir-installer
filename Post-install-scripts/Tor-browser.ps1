...
if (Test-Path -Path "C:\DFIR\Tor-browser") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Browser\Tor-browser.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Tor-browser" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Tor-browser"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Browser\Tor-browser.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Tor-browser\Tor-browser.exe" -Force
