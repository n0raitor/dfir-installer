...
if (Test-Path -Path "C:\DFIR\SilkETW") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Utilities\SilkETW.lnk" -ItemType SymbolicLink -Target "C:\DFIR\SilkETW" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\SilkETW"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Utilities\SilkETW.lnk" -ItemType SymbolicLink -Target "C:\DFIR\SilkETW\SilkETW.exe" -Force
