...
if (Test-Path -Path "C:\DFIR\Ubuntu2204") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Linux\Ubuntu2204.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Ubuntu2204" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Ubuntu2204"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Linux\Ubuntu2204.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Ubuntu2204\Ubuntu2204.exe" -Force
