...
if (Test-Path -Path "C:\DFIR\Redline") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Forensic Suits\Redline.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Redline" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Redline"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Forensic Suits\Redline.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Redline\Redline.exe" -Force
