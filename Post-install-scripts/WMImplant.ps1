...
if (Test-Path -Path "C:\DFIR\WMImplant") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Offensive\WMImplant.lnk" -ItemType SymbolicLink -Target "C:\DFIR\WMImplant" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\WMImplant"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Offensive\WMImplant.lnk" -ItemType SymbolicLink -Target "C:\DFIR\WMImplant\WMImplant.exe" -Force
