...
if (Test-Path -Path "C:\DFIR\KeePass") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Utilities\KeePass.lnk" -ItemType SymbolicLink -Target "C:\DFIR\KeePass" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\KeePass"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Utilities\KeePass.lnk" -ItemType SymbolicLink -Target "C:\DFIR\KeePass\KeePass.exe" -Force
