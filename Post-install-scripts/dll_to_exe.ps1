...
if (Test-Path -Path "C:\DFIR\dll_to_exe") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Other\dll_to_exe.lnk" -ItemType SymbolicLink -Target "C:\DFIR\dll_to_exe" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\dll_to_exe"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Other\dll_to_exe.lnk" -ItemType SymbolicLink -Target "C:\DFIR\dll_to_exe\dll_to_exe.exe" -Force
