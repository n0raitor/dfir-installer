...
if (Test-Path -Path "C:\DFIR\peepdf") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Malware Analysis\peepdf.lnk" -ItemType SymbolicLink -Target "C:\DFIR\peepdf" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\peepdf"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Malware Analysis\peepdf.lnk" -ItemType SymbolicLink -Target "C:\DFIR\peepdf\peepdf.exe" -Force
