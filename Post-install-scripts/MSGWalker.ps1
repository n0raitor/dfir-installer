...
if (Test-Path -Path "C:\DFIR\MSGWalker") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Other\MSGWalker.lnk" -ItemType SymbolicLink -Target "C:\DFIR\MSGWalker" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\MSGWalker"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Other\MSGWalker.lnk" -ItemType SymbolicLink -Target "C:\DFIR\MSGWalker\MSGWalker.exe" -Force
