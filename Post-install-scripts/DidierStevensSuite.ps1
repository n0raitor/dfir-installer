...
if (Test-Path -Path "C:\DFIR\DidierStevensSuite") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Collections\DidierStevensSuite.lnk" -ItemType SymbolicLink -Target "C:\DFIR\DidierStevensSuite" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\DidierStevensSuite"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Collections\DidierStevensSuite.lnk" -ItemType SymbolicLink -Target "C:\DFIR\DidierStevensSuite\DidierStevensSuite.exe" -Force
