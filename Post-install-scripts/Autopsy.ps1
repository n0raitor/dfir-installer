...
if (Test-Path -Path "C:\DFIR\Autopsy") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Forensic Suits\Autopsy.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Autopsy" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Autopsy"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Forensic Suits\Autopsy.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Autopsy\Autopsy.exe" -Force
