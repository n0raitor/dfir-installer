...
if (Test-Path -Path "C:\DFIR\PowerToys") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Recommended\PowerToys.lnk" -ItemType SymbolicLink -Target "C:\DFIR\PowerToys" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\PowerToys"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Recommended\PowerToys.lnk" -ItemType SymbolicLink -Target "C:\DFIR\PowerToys\PowerToys.exe" -Force
