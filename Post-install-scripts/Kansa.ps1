...
if (Test-Path -Path "C:\DFIR\Kansa") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Frameworks\Kansa.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Kansa" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Kansa"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Frameworks\Kansa.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Kansa\Kansa.exe" -Force
