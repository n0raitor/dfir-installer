...
if (Test-Path -Path "C:\DFIR\exe2aut") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Other\exe2aut.lnk" -ItemType SymbolicLink -Target "C:\DFIR\exe2aut" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\exe2aut"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Other\exe2aut.lnk" -ItemType SymbolicLink -Target "C:\DFIR\exe2aut\exe2aut.exe" -Force
