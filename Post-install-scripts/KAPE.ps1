...
if (Test-Path -Path "C:\DFIR\KAPE") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Acquisition Tools\KAPE.lnk" -ItemType SymbolicLink -Target "C:\DFIR\KAPE" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\KAPE"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Acquisition Tools\KAPE.lnk" -ItemType SymbolicLink -Target "C:\DFIR\KAPE\KAPE.exe" -Force
