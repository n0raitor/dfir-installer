...
if (Test-Path -Path "C:\DFIR\peframe") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Malware Analysis\peframe.lnk" -ItemType SymbolicLink -Target "C:\DFIR\peframe" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\peframe"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Malware Analysis\peframe.lnk" -ItemType SymbolicLink -Target "C:\DFIR\peframe\peframe.exe" -Force
