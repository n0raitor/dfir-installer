...
if (Test-Path -Path "C:\DFIR\PEDetective") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Malware Analysis\PEDetective.lnk" -ItemType SymbolicLink -Target "C:\DFIR\PEDetective" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\PEDetective"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Malware Analysis\PEDetective.lnk" -ItemType SymbolicLink -Target "C:\DFIR\PEDetective\PEDetective.exe" -Force
