...
if (Test-Path -Path "C:\DFIR\DeepSound") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Stegano\DeepSound.lnk" -ItemType SymbolicLink -Target "C:\DFIR\DeepSound" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\DeepSound"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Stegano\DeepSound.lnk" -ItemType SymbolicLink -Target "C:\DFIR\DeepSound\DeepSound.exe" -Force
