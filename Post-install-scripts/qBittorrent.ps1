...
if (Test-Path -Path "C:\DFIR\qBittorrent") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Network\qBittorrent.lnk" -ItemType SymbolicLink -Target "C:\DFIR\qBittorrent" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\qBittorrent"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Network\qBittorrent.lnk" -ItemType SymbolicLink -Target "C:\DFIR\qBittorrent\qBittorrent.exe" -Force
