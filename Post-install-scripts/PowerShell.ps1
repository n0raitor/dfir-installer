...
if (Test-Path -Path "C:\DFIR\PowerShell") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Recommended\PowerShell.lnk" -ItemType SymbolicLink -Target "C:\DFIR\PowerShell" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\PowerShell"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Recommended\PowerShell.lnk" -ItemType SymbolicLink -Target "C:\DFIR\PowerShell\PowerShell.exe" -Force
