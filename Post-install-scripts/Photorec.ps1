...
$destinationLnk = "C:\DFIR\_Tools\Artifact Tools\photorec_win.exe"
...
# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Artifact Tools\Photorec" -ItemType SymbolicLink -Target "C:\DFIR\Photorec\Photorec.exe" -Force
