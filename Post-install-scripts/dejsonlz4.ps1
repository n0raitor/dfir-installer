...
if (Test-Path -Path "C:\DFIR\dejsonlz4") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Browser Tools\dejsonlz4.lnk" -ItemType SymbolicLink -Target "C:\DFIR\dejsonlz4" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\dejsonlz4"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Browser Tools\dejsonlz4.lnk" -ItemType SymbolicLink -Target "C:\DFIR\dejsonlz4\dejsonlz4.exe" -Force
