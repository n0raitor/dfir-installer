...
if (Test-Path -Path "C:\DFIR\ReCsvEdit") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Editors\ReCsvEdit.lnk" -ItemType SymbolicLink -Target "C:\DFIR\ReCsvEdit" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\ReCsvEdit"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Editors\ReCsvEdit.lnk" -ItemType SymbolicLink -Target "C:\DFIR\ReCsvEdit\ReCsvEdit.exe" -Force
