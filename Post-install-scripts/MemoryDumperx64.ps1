...
if (Test-Path -Path "C:\DFIR\MemoryDumperx64") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Volatile\MemoryDumperx64.lnk" -ItemType SymbolicLink -Target "C:\DFIR\MemoryDumperx64" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\MemoryDumperx64"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Volatile\MemoryDumperx64.lnk" -ItemType SymbolicLink -Target "C:\DFIR\MemoryDumperx64\MemoryDumperx64.exe" -Force
