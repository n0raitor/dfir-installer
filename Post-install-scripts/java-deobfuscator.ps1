...
if (Test-Path -Path "C:\DFIR\java-deobfuscator") {
    ...
    New-Item -Path "C:\DFIR\_Tools\SRE\java-deobfuscator.lnk" -ItemType SymbolicLink -Target "C:\DFIR\java-deobfuscator" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\java-deobfuscator"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\SRE\java-deobfuscator.lnk" -ItemType SymbolicLink -Target "C:\DFIR\java-deobfuscator\java-deobfuscator.exe" -Force
