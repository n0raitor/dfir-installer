...
if (Test-Path -Path "C:\DFIR\SearchMyFiles") {
    ...
    New-Item -Path "C:\DFIR\_Tools\System Utilities\SearchMyFiles.lnk" -ItemType SymbolicLink -Target "C:\DFIR\SearchMyFiles" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\SearchMyFiles"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\System Utilities\SearchMyFiles.lnk" -ItemType SymbolicLink -Target "C:\DFIR\SearchMyFiles\SearchMyFiles.exe" -Force
