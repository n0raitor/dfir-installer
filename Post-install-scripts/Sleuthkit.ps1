...
if (Test-Path -Path "C:\DFIR\Sleuthkit") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Frameworks\Sleuthkit.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Sleuthkit" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Sleuthkit"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Frameworks\Sleuthkit.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Sleuthkit\Sleuthkit.exe" -Force
