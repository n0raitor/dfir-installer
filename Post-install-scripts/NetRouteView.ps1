...
if (Test-Path -Path "C:\DFIR\NetRouteView") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Other\NetRouteView.lnk" -ItemType SymbolicLink -Target "C:\DFIR\NetRouteView" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\NetRouteView"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Other\NetRouteView.lnk" -ItemType SymbolicLink -Target "C:\DFIR\NetRouteView\NetRouteView.exe" -Force
