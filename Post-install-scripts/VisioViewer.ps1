...
if (Test-Path -Path "C:\DFIR\VisioViewer") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Office\VisioViewer.lnk" -ItemType SymbolicLink -Target "C:\DFIR\VisioViewer" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\VisioViewer"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Office\VisioViewer.lnk" -ItemType SymbolicLink -Target "C:\DFIR\VisioViewer\VisioViewer.exe" -Force
