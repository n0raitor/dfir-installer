...
if (Test-Path -Path "C:\DFIR\Plaso") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Post-Processing\Plaso.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Plaso" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Plaso"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Post-Processing\Plaso.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Plaso\Plaso.exe" -Force
