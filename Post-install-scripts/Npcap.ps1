...
if (Test-Path -Path "C:\DFIR\Npcap") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Network\Npcap.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Npcap" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Npcap"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Network\Npcap.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Npcap\Npcap.exe" -Force
