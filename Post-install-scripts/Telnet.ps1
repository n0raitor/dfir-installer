...
if (Test-Path -Path "C:\DFIR\Telnet") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Network\Telnet.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Telnet" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Telnet"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Network\Telnet.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Telnet\Telnet.exe" -Force
