...
if (Test-Path -Path "C:\DFIR\NetworkMiner") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Network\NetworkMiner.lnk" -ItemType SymbolicLink -Target "C:\DFIR\NetworkMiner" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\NetworkMiner"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Network\NetworkMiner.lnk" -ItemType SymbolicLink -Target "C:\DFIR\NetworkMiner\NetworkMiner.exe" -Force
