...
if (Test-Path -Path "C:\DFIR\VCRedist2015x64") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Frameworks\VCRedist2015x64.lnk" -ItemType SymbolicLink -Target "C:\DFIR\VCRedist2015x64" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\VCRedist2015x64"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Frameworks\VCRedist2015x64.lnk" -ItemType SymbolicLink -Target "C:\DFIR\VCRedist2015x64\VCRedist2015x64.exe" -Force
