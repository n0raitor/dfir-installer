...
if (Test-Path -Path "C:\DFIR\RegRipper3.0") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Registry Tools\RegRipper3.0.lnk" -ItemType SymbolicLink -Target "C:\DFIR\RegRipper3.0" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\RegRipper3.0"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Registry Tools\RegRipper3.0.lnk" -ItemType SymbolicLink -Target "C:\DFIR\RegRipper3.0\RegRipper3.0.exe" -Force
