...
if (Test-Path -Path "C:\DFIR\VSTOR") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Utilities\VSTOR.lnk" -ItemType SymbolicLink -Target "C:\DFIR\VSTOR" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\VSTOR"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Utilities\VSTOR.lnk" -ItemType SymbolicLink -Target "C:\DFIR\VSTOR\VSTOR.exe" -Force
