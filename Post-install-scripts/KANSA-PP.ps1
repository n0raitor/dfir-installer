...
if (Test-Path -Path "C:\DFIR\KANSA-PP") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Custom\KANSA-PP.lnk" -ItemType SymbolicLink -Target "C:\DFIR\KANSA-PP" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\KANSA-PP"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Custom\KANSA-PP.lnk" -ItemType SymbolicLink -Target "C:\DFIR\KANSA-PP\KANSA-PP.exe" -Force
