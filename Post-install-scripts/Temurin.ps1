...
if (Test-Path -Path "C:\DFIR\Temurin") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Other\Temurin.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Temurin" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Temurin"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Other\Temurin.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Temurin\Temurin.exe" -Force
