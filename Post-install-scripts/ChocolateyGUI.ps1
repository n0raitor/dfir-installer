...
if (Test-Path -Path "C:\DFIR\ChocolateyGUI") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Package Manager\ChocolateyGUI.lnk" -ItemType SymbolicLink -Target "C:\DFIR\ChocolateyGUI" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\ChocolateyGUI"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Package Manager\ChocolateyGUI.lnk" -ItemType SymbolicLink -Target "C:\DFIR\ChocolateyGUI\ChocolateyGUI.exe" -Force
