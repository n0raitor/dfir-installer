...
if (Test-Path -Path "C:\DFIR\Binary Ninja") {
    ...
    New-Item -Path "C:\DFIR\_Tools\SRE\Binary Ninja.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Binary Ninja" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Binary Ninja"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\SRE\Binary Ninja.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Binary Ninja\Binary Ninja.exe" -Force
