...
$destinationLnk = "C:\DFIR\_Tools\Debugger\OLLYDBG.exe"
...
# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Debugger\Ollydbg" -ItemType SymbolicLink -Target "C:\DFIR\Ollydbg\Ollydbg.exe" -Force
