...
if (Test-Path -Path "C:\DFIR\RegExport") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Registry Tools\RegExport.lnk" -ItemType SymbolicLink -Target "C:\DFIR\RegExport" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\RegExport"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Registry Tools\RegExport.lnk" -ItemType SymbolicLink -Target "C:\DFIR\RegExport\RegExport.exe" -Force
