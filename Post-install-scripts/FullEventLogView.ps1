...
if (Test-Path -Path "C:\DFIR\FullEventLogView") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Event Log Tools\FullEventLogView.lnk" -ItemType SymbolicLink -Target "C:\DFIR\FullEventLogView" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\FullEventLogView"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Event Log Tools\FullEventLogView.lnk" -ItemType SymbolicLink -Target "C:\DFIR\FullEventLogView\FullEventLogView.exe" -Force
