...
if (Test-Path -Path "C:\DFIR\JavaDecompilerGUI") {
    ...
    New-Item -Path "C:\DFIR\_Tools\SRE\JavaDecompilerGUI.lnk" -ItemType SymbolicLink -Target "C:\DFIR\JavaDecompilerGUI" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\JavaDecompilerGUI"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\SRE\JavaDecompilerGUI.lnk" -ItemType SymbolicLink -Target "C:\DFIR\JavaDecompilerGUI\JavaDecompilerGUI.exe" -Force
