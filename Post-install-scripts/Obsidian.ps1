...
if (Test-Path -Path "C:\DFIR\Obsidian") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Office\Obsidian.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Obsidian" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Obsidian"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Office\Obsidian.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Obsidian\Obsidian.exe" -Force
