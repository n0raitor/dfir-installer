...
if (Test-Path -Path "C:\DFIR\samdump") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Offensive\samdump.lnk" -ItemType SymbolicLink -Target "C:\DFIR\samdump" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\samdump"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Offensive\samdump.lnk" -ItemType SymbolicLink -Target "C:\DFIR\samdump\samdump.exe" -Force
