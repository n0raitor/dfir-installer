...
if (Test-Path -Path "C:\DFIR\UI.Xaml2.7") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Frameworks\UI.Xaml2.7.lnk" -ItemType SymbolicLink -Target "C:\DFIR\UI.Xaml2.7" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\UI.Xaml2.7"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Frameworks\UI.Xaml2.7.lnk" -ItemType SymbolicLink -Target "C:\DFIR\UI.Xaml2.7\UI.Xaml2.7.exe" -Force
