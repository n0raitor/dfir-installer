...
if (Test-Path -Path "C:\DFIR\ProtonMail") {
    ...
    New-Item -Path "C:\DFIR\_Tools\System Utilities\ProtonMail.lnk" -ItemType SymbolicLink -Target "C:\DFIR\ProtonMail" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\ProtonMail"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\System Utilities\ProtonMail.lnk" -ItemType SymbolicLink -Target "C:\DFIR\ProtonMail\ProtonMail.exe" -Force
