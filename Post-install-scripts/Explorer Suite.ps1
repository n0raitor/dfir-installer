...
if (Test-Path -Path "C:\DFIR\Explorer Suite") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Suite\Explorer Suite.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Explorer Suite" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Explorer Suite"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Suite\Explorer Suite.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Explorer Suite\Explorer Suite.exe" -Force
