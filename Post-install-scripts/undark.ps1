...
if (Test-Path -Path "C:\DFIR\undark") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Browser Tools\undark.lnk" -ItemType SymbolicLink -Target "C:\DFIR\undark" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\undark"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Browser Tools\undark.lnk" -ItemType SymbolicLink -Target "C:\DFIR\undark\undark.exe" -Force
