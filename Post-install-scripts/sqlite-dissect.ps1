...
if (Test-Path -Path "C:\DFIR\sqlite-dissect") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Browser Tools\sqlite-dissect.lnk" -ItemType SymbolicLink -Target "C:\DFIR\sqlite-dissect" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\sqlite-dissect"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Browser Tools\sqlite-dissect.lnk" -ItemType SymbolicLink -Target "C:\DFIR\sqlite-dissect\sqlite-dissect.exe" -Force
