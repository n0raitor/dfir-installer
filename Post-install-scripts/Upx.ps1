...
if (Test-Path -Path "C:\DFIR\Upx") {
    # Create symlink if tool directory exists
    New-Item -Path "C:\DFIR\_Tools\SRE\Upx.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Upx" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Upx"
}
