...
if (Test-Path -Path "C:\DFIR\Autopsy-Addons") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Forensic Suits\Autopsy-Addons.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Autopsy-Addons" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Autopsy-Addons"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Forensic Suits\Autopsy-Addons.lnk" -ItemType SymbolicLink -Target "C:\DFIR\Autopsy-Addons\Autopsy-Addons.exe" -Force
