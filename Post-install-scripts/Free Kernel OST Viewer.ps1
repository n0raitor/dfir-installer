...
if (Test-Path -Path "C:\DFIR\Free Kernel OST Viewer") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Email Tools\Free Kernel OST Viewer" -ItemType SymbolicLink -Target "C:\DFIR\Free Kernel OST Viewer" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\Free Kernel OST Viewer"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Email Tools\Free Kernel OST Viewer" -ItemType SymbolicLink -Target "C:\DFIR\Free Kernel OST Viewer\Free Kernel OST Viewer.exe" -Force
