...
if (Test-Path -Path "C:\DFIR\NirSoft WhoisThisDomain") {
    ...
    New-Item -Path "C:\DFIR\_Tools\DEP\NirSoft WhoisThisDomain.lnk" -ItemType SymbolicLink -Target "C:\DFIR\NirSoft WhoisThisDomain" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\NirSoft WhoisThisDomain"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\DEP\NirSoft WhoisThisDomain.lnk" -ItemType SymbolicLink -Target "C:\DFIR\NirSoft WhoisThisDomain\NirSoft WhoisThisDomain.exe" -Force
