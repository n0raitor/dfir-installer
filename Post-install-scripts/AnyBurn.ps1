...
if (Test-Path -Path "C:\DFIR\AnyBurn") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Media\AnyBurn.lnk" -ItemType SymbolicLink -Target "C:\DFIR\AnyBurn" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\AnyBurn"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Media\AnyBurn.lnk" -ItemType SymbolicLink -Target "C:\DFIR\AnyBurn\AnyBurn.exe" -Force
