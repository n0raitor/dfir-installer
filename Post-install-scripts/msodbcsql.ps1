...
if (Test-Path -Path "C:\DFIR\msodbcsql") {
    ...
    New-Item -Path "C:\DFIR\_Tools\Other\msodbcsql.lnk" -ItemType SymbolicLink -Target "C:\DFIR\msodbcsql" -Force
} else {
    Write-Host "Tool directory does not exist: C:\DFIR\msodbcsql"
}

# Create symlink
#New-Item -Path "C:\DFIR\_Tools\Other\msodbcsql.lnk" -ItemType SymbolicLink -Target "C:\DFIR\msodbcsql\msodbcsql.exe" -Force
